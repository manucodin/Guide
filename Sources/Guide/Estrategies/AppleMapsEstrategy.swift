...
internal class AppleMapsEstrategy: RouteredEstrategyProtocol {
    var name: String {
        "Apple Maps"
    }
    ...
    private func modeParam(mode: RouteMode) -> URLQueryItem? {
        ...
        return URLQueryItem(name: "dirflg", value: modeValue)
    }
